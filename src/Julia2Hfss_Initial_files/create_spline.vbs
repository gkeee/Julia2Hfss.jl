...
Array("NAME:PLPoint", "X:=", "5mm", "Y:=", "10mm", "Z:=", "0mm"),  _
Array("NAME:PLPoint", "X:=", "10mm", "Y:=", "0mm", "Z:=", "0mm"),  _
Array("NAME:PLPoint", "X:=", "15mm", "Y:=", "-10mm", "Z:=", "0mm")),  _
  ...
  "Corner")), Array("NAME:Attributes", "Name:=", "MertLines", "Flags:=", "", "Color:=",  _
